<div class="container">
    <div class="float-right">
        <a href="#modalForm" data-toggle="modal" data-href="{{url('materia/create')}}"
        ...
        <div class="col-sm-5 form-group">
            <div class="input-group">
                <input class="form-control" id="search"
                       ...
                       onkeydown="if (event.keyCode == 13) ajaxLoad('{{url('materia')}}?search='+this.value)"
                       placeholder="Search name" name="search"
                       type="text" id="search"/>
                <div class="input-group-btn">
                    <button type="submit" class="btn btn-warning"
                            onclick="ajaxLoad('{{url('materia')}}?search='+$('#search').val())"
                    >
                        Buscar
                    </button>
                </div>
    ...
    <table class="table table-bordered bg-light">
        ...
        <tr>
            ...
            <th style="vertical-align: middle">
                <a href="javascript:ajaxLoad('{{url('materia?field=descripcion&sort='.(request()->session()->get('sort')=='asc'?'desc':'asc'))}}')">
                    Name
                </a>
            ...
            <tr>
                ...
                <td style="vertical-align: middle" align="center">
                    <a class="btn btn-primary btn-sm" title="Edit" href="#modalForm" data-toggle="modal"
                       data-href="{{url('materia/update/'.$materia->id)}}">
                        Editar</a>
